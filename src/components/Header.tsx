import HomeImg from "../assets/images/imgRight.svg";
    ...
    <div className="w-full flex md:flex-row flex-col items-center justify-between md:px-[120px] px-5 md:h-[calc(100vh-80px)] relative md:pb-0 pb-20">
      <div className="flex flex-col gap-6 md:mt-0 mt-5">
        ...
        <div className="flex items-center gap-5">
          <button className="bg-primary text-black text-center cursor-pointer rounded-[40px] w-[150px] h-[50px]">
            Get Started
          </button>
          <button className="text-light border border-grayborder text-center cursor-pointer rounded-[40px] w-[190px] h-[50px]">
            Watch video
          </button>
        </div>
      </div>
      <img
        ...
        loading="lazy"
      />
      <div className="absolute top-1/2 left-[200px] -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-overlay/10 blur-3xl"></div>
    </div>
  );
};
